...
def generate_ea_tars_page(out_loc=None):
    ...
    data['global_cdu_runs_impact'] = seas_chart(tar_series('CDU', region='global', value_col='estimated runs impact'),
    ...
    ju.render_html(data, 'tars_dashboard.html', filename=out_loc, package_loader_name='oilanalytics.energyaspects')
